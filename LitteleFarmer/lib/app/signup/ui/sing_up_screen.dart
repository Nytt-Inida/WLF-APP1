...
class _SingUpScreenState extends State<SingUpScreen> {
  late SingUpProvider provider;

  @override
  void initState() {
    super.initState();
    provider = Provider.of<SingUpProvider>(context, listen: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer(
        builder: (context, SingUpProvider provider, _) {
          return Stack(
            children: [
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            provider.country,
                            style: TextStyle(color: CommonColor.black, fontSize: 15.sp, fontWeight: FontWeight.normal, fontFamily: Constant.manrope),
                          ),
                        ),
                      ),
                      SizedBox(height: 20.h),
                      ...
                      SizedBox(
                        ...
                        child: TextButton(
                          onPressed: () {
                            provider.checkValidation(context: context);
                          },
                          ...
                          child: Text(CommonString.signup.toUpperCase(),
